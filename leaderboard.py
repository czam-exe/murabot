...
async def post_leaderboard(bot, channel):
    ...
    if swearers:
        ...
        champion_embed = discord.Embed(title="Pinaka gago ngayong araw", color=discord.Color.red())
    ...
    if swearers:
        ...
        jar_embed = discord.Embed(title="Profanity Jar", description="Nabuhusan ng holly water ang lahat", color=discord.Color.gold())
